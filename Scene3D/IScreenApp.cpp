...
namespace GraphysX
{
	...
	void IScreenApp::onSDLEvent(SDL_Event& evnt) 
	{
		if (m_currentScreen && m_currentScreen->getState() == ScreenState::RUNNING) 
		{
			m_currentScreen->m_gui.Update(CLTV3D::getTimeElapsed());  // TODO:  check si oki que ca soit de TV3D
			...
			case SDL_WINDOWEVENT:
				...
				case SDL_WINDOWEVENT_RESIZED:
					...
					//GraphysX::CLTV3D::pTV.GetViewport()->Resize();  // TODO  : enlever les TV3D en comment
					break;
			...
			case SDL_KEYDOWN:
				...
				case SDLK_PRINTSCREEN:
					...
					//GraphysX::CLTV3D::ScreenShot((char*)str.c_str(), cCONST_TV_IMAGEFORMAT::cTV_IMAGE_PNG);
