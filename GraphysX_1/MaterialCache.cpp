...
namespace GraphysX
{
	...
	int MaterialCache::getMaterial(eMATERIAL matType)  //  TODO :  touver une facon de combiner un material et une couleur...
	{
		...
		if (iMatDefault == -1)
		{
			...
			pTVMatFac.SetAmbient(iTranslucentMaterial, 0.25f, 0.25f, 0.25f, 0.25f);
			pTVMatFac.SetDiffuse(iTranslucentMaterial, 0.75f, 0, 0, 0.25f);
			pTVMatFac.SetSpecular(iTranslucentMaterial, 1, 0, 0, 0.25f);
