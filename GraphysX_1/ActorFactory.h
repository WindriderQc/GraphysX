...
private:	
	...
	int   IDNormal;              //This is an ID for our bump texture. RGB is a normal map, A is a parallax map. 
	           					//I've done it this way to demonstrate that you can pack data in textures. So here we 
	                            //have all of our required bumping information in one sole RGBA texture map - instead of 
	                            //2 seperate ones.
	NewtonWorld* World;
