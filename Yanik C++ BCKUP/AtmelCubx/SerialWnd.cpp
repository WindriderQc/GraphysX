...
#include "StdAfx.h"
#include <crtdbg.h>  // Pour enlever le  #define _RPTF0(rptno, msg)    de StdAfx.h
...
const UINT CSerialWnd::mg_nDefaultComMsg = ::RegisterWindowMessage((LPCTSTR)_T("CSerialWnd_DefaultComMsg"));
