...
for(i=0;i<100;i++)
  {
	...
	stRings[i].clRingMesh = new CL3DObject("media\\Ring.tvm", NULL, cTV_3DVECTOR(0,1000,0),cTV_3DVECTOR(stRings[i].fSize,stRings[i].fSize,stRings[i].fSize), true, 0, true);
