...
void CLScene::ManageCamCtrl(float fWalk, float fStrafe, float fRaise, float fMouseDeltaX, float fMouseDeltaY,float ElapsedTime)
{}

void CLScene::DrawMeshAxis(CTVMesh* mesh, int iAxisLength)
{
	cTV_3DVECTOR VecPos;
...
void CLScene::DrawTV3DAxis(void)
{
