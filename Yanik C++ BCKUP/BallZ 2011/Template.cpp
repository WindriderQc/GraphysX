...
{		
	...
	strncpy(copyPath, PathOfFile, MAX_PATH-1);
                     ...
                     int       nCmdShow)
{
	...
	clGlobalVar->Set3DWindowHandle(formHWND);
	clGlobalVar->SetSearchPath(path);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_DESTROY:
		// Stop the loop.
		bDoLoop = false;
		// Free everything from the simulator.
		delete Simulateur;	
		// Post the Quit msg to windows.
		PostQuitMessage(0);
		break;
	default:
