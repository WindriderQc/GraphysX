...
WindowManager& winMgr = WindowManager::getSingleton();
	...
	clSetupGUI = new CLSetupGUI("GUI\\SetupGUI.layout");
...
void CLTV3DCEGUI::SelectGUI(int iGUI_MODE)   // Devrait pas etre ici mais plutot dans Area.    Et les enable / disable  dans la classe de base GUI
{
	DisableActiveGUI();
