...
namespace Gfx
{
	...
	public:
		...
		GFX_API static int init(HWND window);
		static void kill();
		...
		GFX_API static void renderBegin(bool bZBufferOnly = false);
		GFX_API static void renderEnd();
		...
		GFX_API static CTVEngine pTV;
		GFX_API static CTVScene pTVScene;
