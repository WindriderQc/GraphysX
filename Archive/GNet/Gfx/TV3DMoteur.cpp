...
{ 
	...
	CTVInternalObjects CLTV3D::pTVIntObj;  // Pointer on TV3D Internal objects
	...
	int CLTV3D::init(HWND window)
	{
		if (w3DWindowHandle == nullptr)
		{
			w3DWindowHandle = window;		
			std::string AppPath = getexepath();
