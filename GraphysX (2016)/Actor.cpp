...
CLActor::CLActor(CTVShader* m_Shader)
{
...
CLActor::CLActor(char* Name, char* Path, cTV_3DVECTOR Pos, CTVShader* m_Shader, NewtonWorld* World)
{
	
	tvActor = clTV3D.pTVScene.CreateActor(Name);
