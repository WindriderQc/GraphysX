...
namespace GraphysX
{
	PushPlate::PushPlate(NewtonWorld* world, STMeshParam param, dVector forcepush, dVector forcepull, float masse) 
		: CLDynamicMesh(world, param, ePHYSMAT::DEF_PHYSMAT, masse)
	{
		forcePush = forcepush;
		forcePull = forcepull;
